...
const Navbar: React.FC = () => {
  ...
  const toggleLanguage = () => {
    // 1. Identify which language we want to switch TO
    const targetLang = currentLang === 'en' ? 'hi' : 'en';

    // 2. Find the hidden select box generated by Google Translate
    const selectBox = document.querySelector('.goog-te-combo') as HTMLSelectElement;

    if (selectBox) {
      // 3. Update its value to the target language code
      selectBox.value = targetLang;
      // 4. Dispatch a change event so the GT script knows it was modified
  ...
  return (
    ...
    >
      ...
      <div className={styles.navInner}>
        ...
        {/* ══════════════════════════════════════════
             RIGHT — Action Buttons (Translate Toggle)
        ══════════════════════════════════════════ */}
        <div className={styles.navActions} style={{ display: 'flex', alignItems: 'center' }}>
